    ...
    public class GetWeatherTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                String apiKey = sp.getString("apiKey", "6d3065342e4464ffc366faa0812c86bd");
                URL url = new URL("http://api.openweathermap.org/data/2.5/weather?q=" + URLEncoder.encode(sp.getString("city", ConstantsWeather.DEFAULT_CITY), "UTF-8") + "&lang="+ language +"&appid=" + apiKey);
                ...
                if(urlConnection.getResponseCode() == 200) {
                    ...
                    editor.apply();
                    WeatherReport.saveLastUpdateTime(sp);
                }
                else {
                    // Connection problem
                }
    ...
    class GetLongTermWeatherTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                if(language.equals("cs")) { language = "cz"; }
                String apiKey = sp.getString("apiKey", "6d3065342e4464ffc366faa0812c86bd");
                URL url = new URL("http://api.openweathermap.org/data/2.5/forecast?q=" + URLEncoder.encode(sp.getString("city", ConstantsWeather.DEFAULT_CITY), "UTF-8") + "&lang="+ language +"&mode=json&appid=" + apiKey);
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                BufferedReader r = new BufferedReader(new InputStreamReader(urlConnection.getInputStream()));
