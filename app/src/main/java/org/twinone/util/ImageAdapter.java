...
public class ImageAdapter extends CommonAdapter<MediaObject> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (isFirstTime) {
            ...
            */
            ProcessGalleryFile processGalleryFile = new ProcessGalleryFile(holder.imgThumb, holder.videoDuration, holder.object.getPath(), holder.object.getMediaType(),ImageAdapter.mContext);
            if (tasks == null) {
                tasks = new HashSet<ProcessGalleryFile>();
            }
