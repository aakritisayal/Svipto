...
import org.twinone.Custom.FlatButton;
import org.twinone.Data.AppInfo;
import org.twinone.Fragments.AllAppFragment;
import org.twinone.Fragments.PasswordFragment;
import org.twinone.Utils.AppLockLogEvents;
import org.twinone.Utils.MyUtils;
import org.twinone.util.Main_navigation;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtallow =(TextView) findViewById(R.id.txtallow);
        ...
        img_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent it = new Intent(MainActivity.this, Main_navigation.class);
                startActivity(it);
                finishAffinity();
            }
        });
...
//        t.send(new HitBuilders.AppViewBuilder().build());
      ...
      boolean access=  allowAcess();

        if (Build.VERSION.SDK_INT > 20){

            if(access){
                txtallow.setVisibility(View.GONE);
            }
            else{
                txtallow.setVisibility(View.VISIBLE);
            }
        ...
        toolbar.setNavigationIcon(R.drawable.home_moboost);
    ...
    public Dialog showRateDialog() {
        ...
        flatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //    Toast.makeText(MainActivity.this, "Open playstore Link", Toast.LENGTH_SHORT).show();
